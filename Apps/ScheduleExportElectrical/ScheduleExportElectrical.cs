...
namespace H5Plugins
{
    ...
    public class ScheduleExportElectrical
    {        
        ...
        {           
            ...
            ScheduleExportElectricalMVVM scheduleExportmainView = H5AppExternalApplication.h5App.scheduleExportElectricalMVVM;
            ...
            IEnumerable<ScheduleExportElectricalViewModel> selecteds = scheduleExportmainView.MainViewModel.Where(ps => ps.IsCheckedScheduleName == true);
