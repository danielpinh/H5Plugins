...
namespace H5Plugins
{
    ...
    public class DetalhesTipicos01
    {
        public static void DetTip2(Document doc, UIDocument uidoc)
        {
            try
            {
                //COLLECTOR
                ...
                using (var progressBar = new ProgressBar("Preparando os Detalhes Típicos..."))
                {
                    ...
                    progressBar.RunString<string>(paramValueslistFinal, (paramValue) =>
                    {
                        ...
                        string detalhesTipicosPath = @"D:\Users\daniel.santos\Desktop\DETALHES\" + paramValue + ".DWG";
