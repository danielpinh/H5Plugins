...
namespace H5Plugins
{
    ...
    /// </summary>
    public class ScheduleExportMechanicalEEH : IExternalEventHandler
    {        
        public void Execute(UIApplication app)
        {
            ...
            foreach (ViewSchedule vs in scheduleCollector)
            {
                ...
                {
                    ScheduleExportMechanicalMVVM.MainView.MainViewModel.Add(new ScheduleExportMechanicalViewModel { ScheduleName = vs.Name });                       
                }                
            }
        }
    ...
    public class ScheduleExportMechanicalSaveEEH : IExternalEventHandler
    {
        public void Execute(UIApplication app)
        {        
            UIDocument uidoc = app.ActiveUIDocument;
            Document doc = uidoc.Document;            
            ScheduleExportMechanical se = new ScheduleExportMechanical();          
